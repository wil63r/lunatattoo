...
(function () {
  ...
  var feed = new Instafeed({
    ...
    limit: '9',
    userId: '7849083872',
    accessToken: '7849083872.1677ed0.ec1fd11144a148a4a139428ad83523a8',
    clientId: 'f6097aba6ca44311a57712308fae63c3',
    resolution: 'standard_resolution',
    template: '<li class="portfolio-item illustration"><div class="portfolio-col portfolio-hover-01"><img src="{{image}}" alt="{{caption}}"></div></li>'
  });
  feed.run();
} ());